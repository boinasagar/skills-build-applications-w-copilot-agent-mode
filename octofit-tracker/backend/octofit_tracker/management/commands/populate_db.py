...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Activities
        Activity.objects.create(user='ironman@marvel.com', type='run', duration=30, date='2025-11-13')
        Activity.objects.create(user='batman@dc.com', type='cycle', duration=45, date='2025-11-13')
